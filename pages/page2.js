document.addEventListener("DOMContentLoaded", function() {
    ...
    calcularButton.addEventListener("click", function(event) {
        ...
        // Redireciona para a página "result" com os parâmetros na URL
        window.location.href = `page3.html?homens=${quantidadeHomens}&mulheres=${quantidadeMulheres}&criancas=${quantidadeCriancas}`;
    });
});
